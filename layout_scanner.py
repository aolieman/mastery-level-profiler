#!/usr/bin/python
## GitHub repo: https://github.com/dpapathanasiou/pdfminer-layout-scanner
## Explanation / docs: http://denis.papathanasiou.org/2010/08/04/extracting-text-images-from-pdf-files/
