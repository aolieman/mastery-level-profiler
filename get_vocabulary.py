...
manually_added = {u"name": "uri",
                  ...
                  u"Research": "http://en.wikipedia.org/wiki/Research",
                  u"Advertising": "http://en.wikipedia.org/wiki/Advertising",
                  u"Marketing": "http://en.wikipedia.org/wiki/Marketing",
                  u"Human Computer Interaction": u"http://en.wikipedia.org/wiki/Human\u2013computer_interaction",
                  u"Databases": "http://en.wikipedia.org/wiki/Database",
                  u"Guides": "http://en.wikipedia.org/wiki/User_guide",
                  u"Ergonomics": "http://en.wikipedia.org/wiki/Human_factors_and_ergonomics",
...
manually_corrected = {u"Art Selection": (u"Sunshine", False),
                      ...
                      u"Exit Surveys": (u"Survey Methodology", True),
